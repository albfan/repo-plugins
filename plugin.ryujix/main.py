...
#TODO Config
#EMULATOR_PATH='/home/alberto/.local/share/Ryujinx/Ryujinx'
EMULATOR_PATH='/home/alberto/projects/csharp/Ryujinx/Ryujinx/bin/Debug/net5.0/Ryujinx'
...
def list_games():
    ...
    :type category: str
    """
    result = subprocess.run([EMULATOR_PATH, '--list-games'], stdout=subprocess.PIPE)
